  ...
  return (
    <div className="bg-foreground/5 grid min-h-dvh place-content-center place-items-center gap-y-12 pb-12">
      ...
      <div className="bg-background w-full max-w-sm rounded-md border p-5">
        ...
        <input
          className="w-full rounded-md border px-2 py-1.5 shadow-sm"
          type="email"
        />
        ...
        <div className="grid grid-cols-2 gap-x-4">
          ...
          >
            <button
              className="flex w-full items-center justify-center gap-2 rounded-md border px-8 py-1.5 font-medium shadow-sm"
              type="submit"
            >
              <svg
                className="size-5"
