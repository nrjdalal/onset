  ...
  return (
    <main className="flex flex-col items-center p-5">
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-screen-xl flex-col items-center gap-4 text-center">
          <Link
          ...
          <p className="text-muted-foreground max-w-screen-lg leading-normal sm:text-xl sm:leading-8">
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-screen-md flex-col items-center justify-center gap-4 text-center">
          <h2 className="font-heading text-3xl sm:text-3xl">
            Proudly Open Source
          </h2>
